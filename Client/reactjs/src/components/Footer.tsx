...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to='/'>
                    <img className="h-8 w-auto object-contain" src="/logo.svg" alt="footer logo" />
                </Link>
            ...
            >
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="/" className="hover:underline">thumblify.ai</a></p>
            </motion.div>
        </footer>
    );
}