...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="why use our genarator?" text3="create stunning thumbanails that get  clicks ,without the haslle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI Understands what makes a vedio go viral and desings thumbnail
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop guessing and Start ranking .Our AI create  desings proven to capture attention </p>
