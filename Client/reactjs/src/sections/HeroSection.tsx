        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Genarate your First thumbnai for free  </span>
            ...
            >
                AI Thumbnail Genarator  for your <span className="move-gradient px-3 rounded-xl text-nowrap">Vedios.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting hours  on desing.Get high-converting thumbnails in seconds with our Advance AI.</motion.p>
            ...
            >
                <button onClick={() => navigate('/login')} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    Genarate Now
                </button>
